...
let uri2 = "mongodb://" + (dbconf.auth ? dbconf.username + ":" + dbconf.password + "@" : '') + dbconf.server + ":" + dbconf.port + "/" + dbconf.db2 + (dbconf.auth ? "?authSource="+dbconf.authDb+"" : '')
var db = mongoose.createConnection(uri)
var nodes = mongoose.createConnection(uri2)
    ////////// LOAD MODELS
