...
const version$1 = 'v0.7.1-66ba4e4'; // eslint-disable-line
...
* @class ImageModel
*/
const ImageModel = CoreObject.extend(Object.defineProperties({
  constructor(attrs) {
...
const ProductModel = BaseModel.extend(Object.defineProperties({
  ...
  options: {
    ...
    get: function () {
      ...
      const variants$$1 = this.variants;

      this.memoized.options = baseOptions.map(option => {
        const name = option.name;

        const dupedValues = variants$$1.reduce((valueList, variant) => {
