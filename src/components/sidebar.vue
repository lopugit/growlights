...
q-list.q-flex.q-flex-column.sidebar
  ...
  q-list.no-border.main-list.q-pa-sm.q-pt-lg.q-mt-auto.q-mb-auto.full-width(
    :class=`{
      'flex': true,
  ...
  q-list.no-border.main-list.q-pa-sm.q-pt-lg.q-mt-auto.q-mb-auto.full-width(
    ...
    q-item.full-width.q-pa-no.q-mb-xs(
      ...
      q-item-main.full-width.p-pa-no.q-ma-no(
        ...
        form.full-width.q-pa-no.q-ma-no(
          ...
          q-input.q-mb-sm.no-shadow.border-1.round-borders(
            :value="gosmart($store, 'state.alopu.entity.alopu.password', undefined)"
            @input="setsmart($store, 'state.alopu.entity.alopu.password', $event)"
    ...
    q-item.full-width.q-pa-no.q-mb-xs(
      v-show="showLoginOptions && $store.state.alopu.registerable"
      )
      q-item-main.full-width.p-pa-no.q-ma-no(
        )
        form.full-width.q-pa-no.q-ma-no(
          ...
          q-input.q-mb-sm.no-shadow.border-1.round-borders(
            :value="gosmart($store, 'state.alopu.passwordConfirmation', undefined)"
            @input="setsmart($store, 'state.alopu.passwordConfirmation', $event)"
    ...
    q-item.full-width.q-pa-no.q-mb-xsmd(
      ...
      q-item-main.full-width(
        ...
        ) {{ $store.state.alopu.registerable == 'haventchecked' ? 'sign in or sign up' : $store.state.alopu.registerable ? 'register' : 'login' }}
    q-item.full-width.q-pa-no.q-mb-xsmd(
      v-if="$store.getters.loggedIn"
      )
...
export default {
  ...
  computed: {
    test(){ return this.vgosmart($store, 'state.alopu.entity.alopu.username', undefined) },
    // test: {
    //   get(){
    //     return gosmart($store, 'state.alopu.entity.alopu.username', undefined)
    //   }
    // },
    entity: {
      get(){
